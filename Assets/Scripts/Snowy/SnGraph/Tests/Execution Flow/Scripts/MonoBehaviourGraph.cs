...
namespace Snowy.SnGraph.Tests
{
    ...
    /// </summary>
    [CreateAssetMenu(
        menuName = "SnGraph/MonoBehaviourGraph", 
        fileName = "New MonoBehaviourGraph"
    )]
    [IncludeTags("Math", "Executable", "Flow Control", "MonoBehaviour Events", "MonoBehaviour Subgraph", "Variables", "Constants")]
    public class MonoBehaviourGraph : GraphWithVariables, IExecutes
    { 
