...
{
    /// <summary>
    /// Type that allows you to pass any vector dimension around in a graph.
    /// 
    ...
    public struct DynamicVector : IConvertible
    {
        ...
        public static implicit operator Quaternion(DynamicVector v) => new Quaternion(v.value.x, v.value.y, v.value.z, v.value.w);
        ...
        public static implicit operator DynamicVector(Quaternion q) => new DynamicVector(q.x, q.y, q.z, q.w);
        ...
        // Supported casts
        public float ToSingle(IFormatProvider provider) { return value.x; }
        ...
        public object ToType(Type conversionType, IFormatProvider provider)
        {
            ...
            if (conversionType == typeof(Quaternion)) return (Quaternion)this;
