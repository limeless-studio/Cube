...
using Snowy.SnGraph.Tests.TerrainGenerator;
using UnityEngine;
using UnityEngine.UIElements;

namespace DefaultNamespace.Snowy.SnGraph.Tests
{
    /// <summary>
    ...
    class HeightmapPreviewNodeView : NodeView
    {
        ...
        {
            styleSheets.Add(Resources.Load<StyleSheet>("SnGraphSample/HeightmapPreviewNodeView"));
