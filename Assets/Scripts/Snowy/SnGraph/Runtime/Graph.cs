...
namespace Snowy.SnGraph
{
    ...
    public abstract class Graph : ScriptableObject, IGraph
    {
        ...
        [SerializeReference, HideInInspector] private List<Node> nodes = new List<Node>();
        ...
        [SerializeField, HideInInspector] private List<Comment> comments = new List<Comment>();
        ...
        [SerializeField, HideInInspector] private int assetVersion = 1;
        ...
        public virtual void OnGraphLoad() {}
        ...
        public void RemoveEdge(Port output, Port input)
        {
            ...
            output.Node.Validate(this);
            input.Node.Validate(this);
        }

        public static T Clone<T>(T graph) where T : Graph
        {
            var clone = Graph.CreateInstance<T>();
            
            clone.AddNodes(graph.Nodes);
