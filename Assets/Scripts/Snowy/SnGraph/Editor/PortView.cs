...
using OOrientation = UnityEditor.Experimental.GraphView.Orientation;
...
namespace Snowy.SnGraph
{
    public class PortView : GraphViewPort
    {
        ...
        public PortView(
            OOrientation portOrientation, 
            Direction portDirection, 
            Capacity portCapacity, 
            Type type
        ) : base(portOrientation, portDirection, portCapacity, type)
        {
            styleSheets.Add(Resources.Load<StyleSheet>("SnGraphEditor/PortView"));
        ...
        public static PortView Create(Port port, IEdgeConnectorListener connectorListener) 
        {
            ...
            var view = new PortView((OOrientation)port.Orientation, direction, capacity, port.Type) 
            {
