...
namespace Snowy.SnGraph
{
    ...
    public class CanvasView : GraphView
    {
        ...
        public CanvasView(GraphEditorWindow window)
        {
            ...
            styleSheets.Add(Resources.Load<StyleSheet>("SnGraphEditor/Variables"));
            styleSheets.Add(Resources.Load<StyleSheet>("SnGraphEditor/CanvasView"));
